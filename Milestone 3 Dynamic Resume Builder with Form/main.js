...
function addMoreSkills(event) {
    ...
    newSkill.innerHTML = `<input type="text" name="skills" size="100" placeholder="Skill">`;
    skillsList === null || skillsList === void 0 ? void 0 : skillsList.appendChild(newSkill);
}
(_a = document.getElementById("addSkill")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", addMoreSkills);
...
function submitResume(event) {
   ...
   <link rel="stylesheet" href="gen-style.css">   
        ...
        <body>
    <h1 class="fmrb">3<sup>rd</sup> Milestone Dynamic Interactive Resume Builder</h1>
    <div class="container">
        <!-- Left section -->
        <div class="left">
            <div class="header">
                ...
                <div class="contact">
                    ...
                    <div class="call"><a href="tel:${resumeData.contact}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                fill="#ffff" height="20px" width="20px" version="1.1" id="Layer_1" viewBox="0 0 512 512"
                                xml:space="preserve">
                                <g>
                                    <g>
                                        <path
                    ...
                    <div class="email"><a href="mailto:${resumeData.email}"><svg xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffff" height="20px" width="20px"
                                version="1.1" id="Capa_1" viewBox="0 0 485.638 485.638" xml:space="preserve">
                                <g>
                                    <path
        ...
        .join("")}
            ...
            <div class="r-bottom">
                ...
                <section class="skills">
                    ...
                    <h2 class="h-skill">
                        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="40px" height="35px"
        ...
        <a href="mailto:saud.saleem93@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
